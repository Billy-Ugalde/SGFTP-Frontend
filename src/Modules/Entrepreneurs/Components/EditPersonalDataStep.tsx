...
interface EditPersonalDataStepProps {
  ...
  phonePrimaryError?: string;
  phoneSecondary: string;
  onPhoneSecondaryChange: (val: string) => void;
  phoneSecondaryError?: string;
}

const EditPersonalDataStep = ({
  entrepreneur,
  onNext,
  onCancel,
  renderField,
      ...
      <div className="edit-entrepreneur-form__fields">
        ...
        <div className="edit-entrepreneur-form__row">
          ...
          {renderField('email', {
            ...
            disabled: true,
            readOnly: true,
            initialValue: entrepreneur.person?.email,
            icon: (
              <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {renderField('experience', {
            ...
            withIcon: true,
            initialValue: entrepreneur.experience,
            icon: (
              <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {renderField('facebook_url', {
            ...
            withIcon: true,
            initialValue: entrepreneur.facebook_url,
            icon: (
          ...
          {renderField('instagram_url', {
            ...
            withIcon: true,
            initialValue: entrepreneur.instagram_url,
            icon: (
              <svg fill="currentColor" viewBox="0 0 24 24">
