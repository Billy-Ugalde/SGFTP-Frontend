...
const ConfirmationModal: React.FC<ConfirmationModalProps> = ({
  ...
  return createPortal(
    <div className="confirmation-modal shared-confirmation-modal-root">
      <div
        role="presentation"
      ...
      <div className="confirmation-modal__content">
        <div className={`confirmation-modal__icon ${getTypeClass()}`}>{getIconByType()}</div>
        <div className="confirmation-modal__body">
          <h3 className="confirmation-modal__title">{title}</h3>
          <p className="confirmation-modal__message">{message}</p>
        </div>
        <div className="confirmation-modal__actions">
          <button type="button" onClick={onClose} disabled={isLoading} className="confirmation-modal__cancel-btn">
            {cancelText}
          </button>
          <button
            type="button"
