...
export const ROLE_MODULES = {
  super_admin: ['ferias', 'emprendedores', 'informativo', 'donadores', 'usuarios', 'actividades', 'voluntarios', 'proyectos', 'noticias', 'newsletters'],
...
export type ModuleKey = 'ferias' | 'emprendedores' | 'informativo' | 'donadores' | 'usuarios' | 'actividades' | 'voluntarios' | 'proyectos' | 'noticias' | 'newsletters';
